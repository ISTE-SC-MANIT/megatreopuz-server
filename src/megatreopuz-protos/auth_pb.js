...
proto.auth.LoginResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    acesstoken: jspb.Message.getFieldWithDefault(msg, 1, ""),
...
/**
 * optional string acessToken = 1;
 * @return {string}
 */
proto.auth.LoginResponse.prototype.getAcesstoken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.auth.LoginResponse.prototype.setAcesstoken = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
